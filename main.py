...
components.html(f"""
    <div style="display: flex;">
        <div id="components-list" style="width: 30%; padding: 10px; border-right: 1px solid black;">
            <h3>Survey Components</h3>
        ...
        <div id="survey-canvas" ondrop="drop(event)" ondragover="allowDrop(event)" style="width: 70%; min-height: 400px; padding: 20px; border: 1px solid black;">
            <h3>Survey Canvas</h3>
